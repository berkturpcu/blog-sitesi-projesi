...
namespace Blog.Dal.Repositories.Concrete
{
    public class AppUserRepository : IAppUserRepository
    {
        ...
        public int Update(Appuser appuser)
        {
            ...
            /// Ayrıca EF üzerinden yapılan update işlemlerinde EF devamlı _table nesnesi üzerinden tabloları üzerinde tuttuğu için  bu kod ile de _table.Update(appuser); işlem yapılabilir. 
